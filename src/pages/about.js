...
import { Avatar, Link as ChakraLink, Heading, Text, Box } from '@chakra-ui/core'
...
const About = (props) => {
    return (
        <Container>
            <Main>
                <Box mx={['8', '2']}>
                    <Heading mb={8}>About Hot Seat Questions</Heading>
                    <Text fontSize='xl' fontWeight='semibold'>
                        Hi, I'm <ChakraLink color='red.500' href='https://bobbybytez.io'>Bobby Hall Jr</ChakraLink> creator of hot seat questions. 
                        A little about me... 
